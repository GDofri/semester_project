...
class ArtificialStreaksDatasetWithFixedWidth(Dataset):
    def __init__(self, images, targets, img_width,
                 images_mean=None, images_std=None,
                 targets_mean=None, targets_std=None, eval=False):
...
def split_data_into_datasets(train=0.8, val=0.1, test=0.1, seed=1104, device='cpu', data_path = None, no_samples = -1, min_width=500):
    ...
    # Filter out images with width less than min_width
