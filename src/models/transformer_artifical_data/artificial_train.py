...
from src.models.transformer_artifical_data.artificial_transformer import Transformer
import torch
...
def train(
    ...
    for epoch in range(num_epochs):
        ...
        for padded_sequences, attention_mask, targets in train_loader_tqdm:
    ...
    with torch.no_grad():
        for padded_sequences, attention_mask, targets in test_loader_tqdm:
            padded_sequences = padded_sequences.to(device)
            attention_mask = attention_mask.to(device)
            targets = targets.to(device)
